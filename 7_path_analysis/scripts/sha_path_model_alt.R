...
fwrite(path_parameters_qtl_effects_sun, "sha_qtl_eff_alt_sun.csv", sep = ",", row.names = FALSE, na = "NA")
fwrite(path_parameters_qtl_effects_shade, "sha_qtl_eff_alt_shade.csv", sep = ",", row.names = FALSE, na = "NA")
