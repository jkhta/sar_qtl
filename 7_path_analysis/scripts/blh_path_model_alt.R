...
fwrite(path_trait_correlations_sun, "blh_trait_eff_alt_sun.csv", sep = ",", row.names = FALSE, na = "NA")
fwrite(path_trait_correlations_shade, "blh_trait_eff_alt_shade.csv", sep = ",", row.names = FALSE, na = "NA")
